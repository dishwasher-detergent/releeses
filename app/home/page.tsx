...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="mb-12 w-full rounded-[48px] bg-emerald-950/50 px-8 py-8">
      ...
      <section className="mb-12 w-full px-8 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:col-span-3 md:row-start-3 md:grid-cols-3">
          <div>
            <LucideBuilding2 className="mb-2 size-10 rounded-xl bg-emerald-600 p-2.5 text-white" />
          ...
          <div>
            <LucideRocket className="mb-2 size-10 rounded-xl bg-emerald-600 p-2.5 text-white" />
          ...
          <div>
            <LucideMap className="mb-2 size-10 rounded-xl bg-emerald-600 p-2.5 text-white" />
          ...
          <div>
            <LucideGlobe className="mb-2 size-10 rounded-xl bg-emerald-600 p-2.5 text-white" />
