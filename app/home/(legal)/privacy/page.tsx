export default function Privacy() {
  return (
    <section className="prose mx-auto py-8 dark:prose-invert">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to releeses.com.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to releeses.com, accessible from{" "}
            <a
              href="https://releeses.com"
      ...
      <ul>
        <li>By email: kenny.bass@outlook.com</li>
      </ul>
    </section>
  );
}
