    ...
    <div className="fixed bottom-5 right-5">
      ...
      {open && (
        <form
          ...
          className="absolute bottom-20 right-2 flex w-96 flex-col space-y-6 rounded-lg border border-slate-200 bg-white p-8 shadow-lg animate-in slide-in-from-bottom-5"
        >
          <div>
            <h2 className="font-cal text-xl leading-7 text-slate-900">
              Report Abuse
            </h2>
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                readOnly
                value={url}
                className="block w-full cursor-not-allowed rounded-md border border-slate-200 bg-slate-100 py-1.5 text-slate-900 shadow-sm ring-0 focus:outline-none sm:text-sm sm:leading-6"
              />
            </div>
          </div>
